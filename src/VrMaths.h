...
// Required for Euler angle extensions
...
class VrVec3 : public dvec3 {
  public:
    ...
    [[nodiscard]] auto Dot(const VrVec3& other) const -> value_type { return dot(*this, dvec3{other.x, other.y, other.z}); }
    [[nodiscard]] auto Cross(const Vector3 auto& other) const -> VrVec3 { return cross(*this, make_vec3(other.v)); }
    [[nodiscard]] auto Cross(const VrVec3& other) const -> VrVec3 { return VrVec3{cross(*this, dvec3{other.x, other.y, other.z})}; }
